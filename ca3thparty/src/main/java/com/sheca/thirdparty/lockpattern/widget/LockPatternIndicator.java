package com.sheca.thirdparty.lockpattern.widget;
...
public class LockPatternIndicator extends View {
	...
	private void initPaint() {
		...
		defaultPaint.setColor(getResources().getColor(R.color.white_ffffff));
		defaultPaint.setStrokeWidth(3.0f);
		defaultPaint.setStyle(Style.FILL);
		defaultPaint.setAntiAlias(true);
		
		selectPaint = new Paint();
		selectPaint.setColor(getResources().getColor(R.color.yellow_F7D05B));
