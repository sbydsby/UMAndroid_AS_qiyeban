...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler{
	...
	private Button gotoBtn, regBtn, launchBtn, checkBtn, payBtn, favButton,unregBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	regBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// ����appע�ᵽ΢��
				try{
					 boolean isRegApp = api.registerApp(Constants.APP_ID); 
					 Toast.makeText(WXEntryActivity.this, "isRegisterApp:" + String.valueOf(isRegApp), Toast.LENGTH_LONG).show();  
					 Toast.makeText(WXEntryActivity.this, "isWXAppInstalled:" + String.valueOf(api.isWXAppInstalled()), Toast.LENGTH_LONG).show();  
					 Toast.makeText(WXEntryActivity.this, "isWXAppSupportAPI:" + String.valueOf(api.isWXAppSupportAPI()), Toast.LENGTH_LONG).show();  
				}catch(Exception ex){
				     Toast.makeText(WXEntryActivity.this, "result:" + ex.getMessage(), Toast.LENGTH_LONG).show();
				}
        ...
        unregBtn = (Button) findViewById(R.id.unreg_btn);
