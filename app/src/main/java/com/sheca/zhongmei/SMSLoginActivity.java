...
import com.sheca.zhongmei.interfaces.CertCallBack;
import com.sheca.zhongmei.model.APPResponse;
import com.sheca.zhongmei.model.CertOperateParams;
import com.sheca.zhongmei.presenter.BasePresenter;
import com.sheca.zhongmei.presenter.LoginController;
import com.sheca.zhongmei.util.AccountHelper;
import com.sheca.zhongmei.util.CertEnum;
import com.sheca.zhongmei.util.CertUtils;
...
//                        PushManager.getInstance().bindAlias(SMSLoginActivity.this, accountName);//注册个推别名
                        ...
                        final com.sheca.zhongmei.model.Account account = new com.sheca.zhongmei.model.Account(
                                accountPlus.getName(),
