...
import com.sheca.zhongmei.adapter.ApplicationAdapter;
import com.sheca.zhongmei.companyCert.CertSetPwdActivity;
...
// 		return retState;
    ...
    private void showPayActivity(String strReqNumber, String strStatus, String strCertType) {
        ...
        intent.setClass(CertDownloadActivity.this, com.sheca.zhongmei.PayActivity.class);
