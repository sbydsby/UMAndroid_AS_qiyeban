...
//        webSettings.setDomStorageEnabled(true);
		...
		txt_content.setText(activity.getString(R.string.fryzt_rule1) +activity. getString(R.string.fryzt_rule2) + activity.getString(R.string.fryzt_rule3)+activity.getString(R.string.fryzt_rule4));
		...
		String rule4 = activity.getString(R.string.fryzt_rule4);
