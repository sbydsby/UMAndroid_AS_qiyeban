...
import com.sheca.umandroid.CertChangePwdActivity;
import com.sheca.umandroid.CertDeleteActivity;
import com.sheca.umandroid.CertDetailActivity;
import com.sheca.umandroid.CertRenameActivity;
import com.sheca.umandroid.CertRenewActivity;
import com.sheca.umandroid.CertResetActivity;
import com.sheca.umandroid.CertRevokeActivity;
import com.sheca.umandroid.CertUnlockActivity;
...
//                if (isCertTested(cert.getCertificate()))
    ...
    private void showCertList() {
        view.findViewById(R.id.button_view_cert).setVisibility(RelativeLayout.VISIBLE);
        view.findViewById(R.id.button_change_pwd_cert).setVisibility(RelativeLayout.VISIBLE);
        view.findViewById(R.id.button_reset_pwd_cert).setVisibility(RelativeLayout.GONE);
        view.findViewById(R.id.button_unlock_cert).setVisibility(RelativeLayout.GONE);
        view.findViewById(R.id.button_delete_cert).setVisibility(RelativeLayout.GONE);
        view.findViewById(R.id.button_apply_cert).setVisibility(RelativeLayout.VISIBLE);
        view.findViewById(R.id.button_download_cert).setVisibility(RelativeLayout.VISIBLE);
        ...
        view.findViewById(R.id.button_change_cert).setVisibility(RelativeLayout.VISIBLE);
        ...
        if (mData.size() == 0) {
            ...
            view.findViewById(R.id.button_view_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_change_pwd_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_reset_pwd_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_unlock_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_delete_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_renew_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_revoke_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_change_cert).setVisibility(RelativeLayout.GONE);
//			view.findViewById(R.id.button_apply_cert).setVisibility(RelativeLayout.VISIBLE);
//			view.findViewById(R.id.button_download_cert).setVisibility(RelativeLayout.VISIBLE);
            ...
            view.findViewById(R.id.button_apply_cert).setVisibility(RelativeLayout.GONE);
            view.findViewById(R.id.button_download_cert).setVisibility(RelativeLayout.GONE);
        ...
        ((Button) view.findViewById(R.id.button_view_cert)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
        ...
        ((Button) view.findViewById(R.id.button_change_pwd_cert)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(activity, CertChangePwdActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        ((Button) view.findViewById(R.id.button_reset_pwd_cert)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(activity, CertResetActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        ((Button) view.findViewById(R.id.button_unlock_cert)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(activity, CertUnlockActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        ((Button) view.findViewById(R.id.button_delete_cert)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(activity, CertDeleteActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        button_apply_cert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (accountDao.count() == 0) {
                    if (!AccountHelper.hasLogin(getActivity())) {
...
//                    startActivity(intent);
        ...
        button_download_cert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (accountDao.count() == 0) {
//                    Intent intent = new Intent(context, LoginActivity.class);
//                    startActivity(intent);
        ...
        Button button_renew_cert = (Button) view.findViewById(R.id.button_renew_cert);
        button_renew_cert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
...
//					if(isCertUpdateValid(certDao.getCertByID(certID).getCertificate())){
//						Toast.makeText(context, "不在更新有效期,证书无法进行更新", Toast.LENGTH_SHORT).show();
//						return;
//					}

//					if(certDao.getCertByID(certID).getFingertype() == CommonConst.USE_FINGER_TYPE){
//						Toast.makeText(context, "老系统证书不支持更新", Toast.LENGTH_SHORT).show();
//				        return;
//					}

                    if (!isCertUpdateValidOld(certDao.getCertByID(certID).getCertificate())) {//
                        Toast.makeText(context, "试用证书无法进行更新", Toast.LENGTH_SHORT).show();
                        return;
                    }

                    Intent intent = new Intent(activity, CertRenewActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        Button button_revoke_cert = (Button) view.findViewById(R.id.button_revoke_cert);
        button_revoke_cert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
...
//					if(certDao.getCertByID(certID).getFingertype() == CommonConst.USE_FINGER_TYPE){
//						Toast.makeText(context, "老系统证书不支持撤销", Toast.LENGTH_SHORT).show();
//						return;
//					}

                    Intent intent = new Intent(activity, CertRevokeActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
        ...
        Button button_change_cert = (Button) view.findViewById(R.id.button_change_cert);
        button_change_cert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mData.size() == 0) {
                    Toast.makeText(context, "无证书", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(activity, CertRenameActivity.class);
                    intent.putExtra("CertId", certID + "");
                    startActivity(intent);
                }
            }
...
//        } else {
//            view.findViewById(R.id.Layout_my_info).setBackgroundResource(R.drawable.bg_no_cert);
//            view.findViewById(R.id.Layout_no_cert_info).setBackgroundResource(R.drawable.bg_no_cert);
//        }
    }
...
//	        views.add(inflater.inflate(R.layout.view_cert_item, null));
        views.add(inflater.inflate(R.layout.view_cert_item_v3, null));
    }
...
//                views.get(positionNow).findViewById(R.id.Layout_cert_item).setBackgroundResource(R.drawable.certcardview_normal);
    ...
    private boolean isCertUpdateValidOld(String strCert) {  //判断证书是否需要更新
        String strValidTime = "";
        String strStartTime = "";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
        ...
        try {
            ...
            javasafeengine jse = new javasafeengine();
            strValidTime = jse.getCertDetail(12, bCert);
            strStartTime = jse.getCertDetail(11, bCert);

            Date toDate = sdf.parse(strValidTime);
            Date curDate = sdf.parse(strStartTime);


            long intervalMilli = toDate.getTime() - curDate.getTime();
            int day = (int) (intervalMilli / (24 * 60 * 60 * 1000));
            if (day <= 100)  //小于3个月为试用证书
                return false;
