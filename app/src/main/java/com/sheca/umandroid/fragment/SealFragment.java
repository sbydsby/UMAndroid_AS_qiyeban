   ...
   //private  JShcaKsStd gKsSdk = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		    ...
		    try{
			   ...
			   applyForCert = (Button)view.findViewById(R.id.button_apply_seal);
...
*/
	...
	private  void  showCertList(){
		applyForCert.setVisibility(RelativeLayout.VISIBLE);
		...
		if(mData.size() == 0){
			...
			applyForCert.setVisibility(RelativeLayout.GONE);
		...
		applyForCert.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				  //TODO 申请印章
	...
	private  void  clearCertList(){
		...
		view.findViewById(R.id.Layout_my_info).setOnClickListener(new OnClickListener() {
			@Override
...
//	            	TextView textview = (TextView)views.get(i).findViewById(R.id.certnickname);
////	            	textview.setText(mData.get(i).get("certname"));
					...
					textview.setText(String.valueOf(certID));
...
//	                String day = String.valueOf(CommUtil.getLeftDay(mData.get(i).get("validtime")));
...
//	                	((Button) view.findViewById(R.id.aaaaaaaaaaaaaaa)).setCompoundDrawablesRelativeWithIntrinsicBounds(null,drawable,null,null);
//	                }else{
...
//	                	view.findViewById(R.id.aaaaaaaaaaaaaaa).setVisibility(RelativeLayout.GONE);
//	                else
//	                	view.findViewById(R.id.aaaaaaaaaaaaaaa).setVisibility(RelativeLayout.VISIBLE);
		  ...
		  try{
			  ...
			  if(ShcaCciStd.gSdk != null){
					...
					if(r != null && r.retcode == 0){					
						...
						byte[] bPubkey = null;//Base64.decode(r.pubkey, android.util.Base64.NO_WRAP);
