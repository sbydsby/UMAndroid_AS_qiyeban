...
public class CycleViewEdgePager extends ViewPager {
    ...
    public CycleViewEdgePager(Context context) {
        super( context);
        setOnPageChangeListener( null);
    }

    public CycleViewEdgePager(Context context, AttributeSet attrs) {
        super( context, attrs);
        setOnPageChangeListener( null);
    }
