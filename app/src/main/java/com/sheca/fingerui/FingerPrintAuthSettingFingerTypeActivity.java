 ...
 */
public class FingerPrintAuthSettingFingerTypeActivity extends Activity {
    ...
    private BroadcastReceiver statusReciver;
    {
        statusReciver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                int status = intent.getIntExtra(com.sheca.umandroid.SettingFingerTypeActivity.FingerprintBroadcastUtil.FINGERPRINTSENSOR_STATUS_VALUE, 0);
                ...
                switch (status) {
                    ...
                    case Result.StatusCode.RESULT_TIMEOUT:
                        new FingerPrintToast(FingerPrintAuthSettingFingerTypeActivity.this, status)
                            .show("");
                        break;
                    ...
                    case Result.StatusCode.RESULT_CANCELED:
                       // new FingerPrintToast(FingerPrintAuthLoginActivity.this, status).show("");
                        break;
                    default:
                        break;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(statusReciver, com.sheca.umandroid.SettingFingerTypeActivity.FingerprintBroadcastUtil.getIdentifyChangeBroadcastFilter());
        isExiting = false;
