...
public class FingerPrintAuthActivity extends Activity {
    ...
    private BroadcastReceiver statusReciver;
    {
        statusReciver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                int status = intent.getIntExtra(MainActivity.FingerprintBroadcastUtil.FINGERPRINTSENSOR_STATUS_VALUE, 0);
                ...
                switch (status) {
                    ...
                    case Result.StatusCode.RESULT_TIMEOUT:
                        new FingerPrintToast(FingerPrintAuthActivity.this, status)
                            .show("");
                        break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(statusReciver, MainActivity.FingerprintBroadcastUtil.getIdentifyChangeBroadcastFilter());
        isExiting = false;
    ...
    protected void onDestroy() {
        ...
        MainActivity.authenticator.cancel();
