...
public class FingerPrintAuthLoginActivity extends Activity {
    ...
    private BroadcastReceiver statusReciver;
    {
        statusReciver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                int status = intent.getIntExtra(com.sheca.umandroid.LoginActivity.FingerprintBroadcastUtil.FINGERPRINTSENSOR_STATUS_VALUE, 0);
                ...
                switch (status) {
                    ...
                    case Result.StatusCode.RESULT_TIMEOUT:
                        new FingerPrintToast(FingerPrintAuthLoginActivity.this, status)
                            .show("");
                        break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(statusReciver, com.sheca.umandroid.LoginActivity.FingerprintBroadcastUtil.getIdentifyChangeBroadcastFilter());
        isExiting = false;
