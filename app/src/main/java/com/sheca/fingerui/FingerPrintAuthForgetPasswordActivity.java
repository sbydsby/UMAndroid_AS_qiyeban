 ...
 */
public class FingerPrintAuthForgetPasswordActivity extends Activity {
    ...
    private BroadcastReceiver statusReciver;
    {
        statusReciver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                int status = intent.getIntExtra(com.sheca.umandroid.ForgetPasswordCertActivity.FingerprintBroadcastUtil.FINGERPRINTSENSOR_STATUS_VALUE, 0);
                ...
                switch (status) {
                    ...
                    case Result.StatusCode.RESULT_TIMEOUT:
                        new FingerPrintToast(FingerPrintAuthForgetPasswordActivity.this, status)
                            .show("");
                        break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(statusReciver, com.sheca.umandroid.ForgetPasswordCertActivity.FingerprintBroadcastUtil.getIdentifyChangeBroadcastFilter());
        isExiting = false;
