...
import com.sheca.umee.interfaces.CertCallBack;
import com.sheca.umee.model.APPResponse;
import com.sheca.umee.model.CertOperateParams;
import com.sheca.umee.presenter.BasePresenter;
import com.sheca.umee.presenter.LoginController;
import com.sheca.umee.util.AccountHelper;
import com.sheca.umee.util.CertEnum;
import com.sheca.umee.util.CertUtils;
...
//	            	RegAccountSuccess();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SMSLoginActivity.this, LoginActivityV33.class);
...
//                        PushManager.getInstance().bindAlias(SMSLoginActivity.this, accountName);//注册个推别名
                        ...
                        final com.sheca.umee.model.Account account = new com.sheca.umee.model.Account(
                                accountPlus.getName(),
...
//					final String mAccountInfo = getPersonActive(token, mobile);
                        ...
                        com.sheca.umee.model.Account account = new com.sheca.umee.model.Account(
                                accountPlus.getName(),
                                accountPlus.getPassword(),
                                status,
                                active,
                    ...
                    public void run() {
                        ...
                        if (mList != null && mList.size() != 0) {
                            ...
                            for (int i = 0; i < mList.size(); i++) {
                                com.sheca.umee.model.Cert mCert = new com.sheca.umee.model.Cert();
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mList != null && mList.size() != 0) {
                            ...
                            for (int i = 0; i < mList.size(); i++) {
                                com.sheca.umee.model.SealInfo mSealInfo = new com.sheca.umee.model.SealInfo();
