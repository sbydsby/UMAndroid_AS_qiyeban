...
import com.sheca.umee.listener.BannerViewHolder;
import com.sheca.umee.listener.OnBannerClickListener;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.radius_gray;
    private int mIndicatorUnselectedResId = R.drawable.radius_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.radius_gray);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.radius_white);
...
//        if (isCert) {
//            bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.mipmap.no_cert_new);
//        } else {
//            bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.mipmap.no_seal_new);
//        }
    ...
    public void setIsCert(boolean isCert) {
        this.isCert = isCert;
        if (isCert) {
            bannerBackgroundImage = getResources().getIdentifier("no_cert_new", "mipmap", context.getPackageName());
            bannerDefaultImage.setImageResource(bannerBackgroundImage);
        } else {
            bannerBackgroundImage = getResources().getIdentifier("no_seal_new", "mipmap", context.getPackageName());
            bannerDefaultImage.setImageResource(bannerBackgroundImage);
        }
